...
export function CinematicDivider() {
  return (
    <section className="relative min-h-[54svh] overflow-hidden sm:min-h-[64svh]">
      <Image
      ...
      <div className="relative z-10 mx-auto flex min-h-[54svh] max-w-6xl items-center px-3 py-14 sm:min-h-[64svh] sm:px-4 sm:py-16">
        <div className="max-w-2xl">
          <p className="mb-3 text-[0.65rem] font-black uppercase tracking-[0.28em] text-sunset sm:text-sm sm:tracking-[0.38em]">
