  ...
  return (
    <footer className="relative border-t border-white/10 px-4 py-16">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <p className="mx-auto mt-12 max-w-2xl text-pretty text-[0.7rem] leading-relaxed text-paper/40">
        ...
        <p className="mt-6 text-[0.65rem] uppercase tracking-[0.3em] text-paper/30">
