...
export function Scenes() {
  ...
  return (
    <section id="scenes" className="relative overflow-hidden border-y border-white/10 bg-[#090812] px-3 py-16 sm:px-4 sm:py-32">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_8%,rgba(22,224,255,0.1),transparent_34%),radial-gradient(circle_at_84%_88%,rgba(255,46,151,0.11),transparent_36%)]" />
      <div className="absolute inset-0 opacity-[0.045] travel-grid" aria-hidden />

      <div className="relative mx-auto max-w-6xl">
        <header className="mb-9 grid gap-4 sm:mb-12 lg:grid-cols-[0.7fr_0.3fr] lg:items-end">
          <div>
          ...
          <div className="hidden border-l-2 border-cyan/60 bg-white/[0.028] px-4 py-3 text-right shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] lg:block">
        ...
        <div className="grid gap-5 lg:grid-cols-[1.28fr_0.72fr]">
          <figure className="group relative min-h-[25rem] overflow-hidden rounded-md bg-white/[0.04] ring-1 ring-white/10 sm:min-h-[32rem]">
            <Image
              src={feature.src}
              alt={`${feature.place} - ${feature.title}`}
              fill
              sizes="(max-width: 1024px) 100vw, 62vw"
              className="image-grade object-cover transition duration-700 group-hover:scale-[1.025]"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-ink via-ink/18 to-transparent" />
            <div className="absolute inset-0 bg-gradient-to-r from-ink/60 via-transparent to-transparent" />
            <div className="absolute left-4 top-4 border border-white/[0.12] border-l-[3px] bg-ink/62 px-3 py-2 font-mono text-[0.58rem] font-black uppercase tracking-[0.14em] text-paper/72 backdrop-blur-sm" style={{ borderLeftColor: feature.tone }}>
              Report 01
            </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
            ...
            <figure
                key={scene.place}
                className="group relative min-h-[13rem] overflow-hidden rounded-md border border-white/[0.1] border-l-[3px] bg-white/[0.04] ring-1 ring-white/10 sm:min-h-[14.5rem]"
              ...
              >
                <Image
                  ...
                  className="image-grade object-cover transition duration-700 group-hover:scale-[1.03]"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-ink/95 via-ink/28 to-transparent" />
                <div className="absolute left-4 top-4 font-mono text-[0.54rem] font-black uppercase tracking-[0.14em] text-paper/45">
